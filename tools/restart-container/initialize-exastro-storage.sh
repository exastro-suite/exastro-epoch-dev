...
# volumeの削除
#
sudo rm -rf ${REPOROOT}/.volumes/epoch-db
sudo rm -rf ${REPOROOT}/.volumes/exastro
sudo rm -rf ${REPOROOT}/.volumes/ita-mariadb
sudo rm -rf ${REPOROOT}/.volumes/platform-db
sudo rm -rf ${REPOROOT}/.volumes/storage
